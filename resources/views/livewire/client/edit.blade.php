            ...
            <form class="p-6 sm:p-4 md:p-10 bg-white rounded shadow-xl" role="form"
                ...
                <div class="flex w-full flex-col md:flex-row">
                    <div class="mt-2 w-full md:w-1/2 sm:mr-1">
                        ...
                        <input
                            ...
                            id="dateDeNaissance" wire:model="dateDeNaissance" type="date"
                            placeholder="Date de naissance" aria-label="dateDeNaissance">
                    ...
                    <div class="mt-2 w-full md:w-1/2 sm:ml-1">
                        ...
                        <input
                            ...
                            id="lieuDeNaissance" wire:model="lieuDeNaissance" type="text"
                            placeholder="Nom d'utilisateur" aria-label="lieuDeNaissance">
                ...
                <div class="flex w-full flex-col md:flex-row">
                    <div class="w-full md:w-1/2 sm:mr-1 mt-2">
                        ...
                        <div
                            ...
                            <div class="mx-2">
                                <input class="mr-1" type="radio" wire:model="pieceIdentite" id="passport"
                                    value="Passport">
                ...
                <div class="mt-6 flex flex-wrap flex-row justify-around">
                    ...
                    <button class="px-4 font-extralight py-1 text-white  tracking-wider bg-blue-800 rounded"
                        type="button" wire:click='goToListClient()'><span class="md:hidden">Retour</span><span
